        ...
        <div className="container text-center text-md-start mt-5">
          ...
          <div className="row mt-3">
            ...
            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <p>
                WORLDWIDE PROPERTY SEARCH RE/MAX COMMERCIAL THE RE/MAX
                COLLECTION
              </p>
            </div>
            {/*   Grid column  */}
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              <p>
                <Link to="/apartments" className="text-reset">
                  Explore
                </Link>
              </p>
              <p>
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p>
                <i className="fas fa-phone me-3"></i> + 00 3456467 88
              </p>
              <p>
                <i className="fas fa-print me-3"></i> + 09 4354427 89
              </p>
            </div>
            {/*  Grid column  */}
          </div>
